...
public class AdditionalStringAlignment {
	...
	public static double calculateSimDegree(String s1, String s2) {
		int misMatchPenalty = 3;
		int gapPenalty = 2;
		
		String[] out = getAlignedStrings(s1, s2, misMatchPenalty, gapPenalty);
		...
		return (out[0].length() - Math.max(mismatch1, mismatch2)*1.0)/out[0].length();
	}
	...
	public static void main(String[] args) {
		...
		System.out.println(calculateSimDegree(s1, s2));
