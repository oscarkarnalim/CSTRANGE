...
**Upon acceptance of the relevant publication, CSTRANGE has been updated with a more recent JPlag (v 3.0.0), better JPlag report formatting, and more efficient STRANGE reporting mechanism. For large submissions, it is recommended to use [Scalable STRANGE or SSTRANGE](https://github.com/oscarkarnalim/SSTRANGE) instead.**
